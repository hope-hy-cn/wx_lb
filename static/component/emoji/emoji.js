import EmojiObj from './../../js/emojimap.js'
...
Component({
   ...
   */
  data: {
    localAlbumImages: ['./../../image/album-emoji.png', './../../image/album-ajtd.png', './../../image/album-xxy.png', './../../image/album-lt.png'],
    albumArr: [],
    currentAlbum: 'emoji',
    emojiList: {},
    currentAlbumKeys: [], //存储每一类别的key
    currentIndex:0,  //更新轮播下标
  },
  attached: function() {
    let currentAlbumKeys = this.splitAlbumKeys(Object.keys(EmojiObj.emojiList[this.data.currentAlbum]), this.data.currentAlbum == 'emoji' ? 24 : 10)
    this.setData({
  ...
  methods: {
    ...
    switchAlbum: function(e) {
      ...
      let currentAlbumKeys = this.splitAlbumKeys(Object.keys(this.data.emojiList[currentAlbum]), currentAlbum == 'emoji' ? 24 : 10, currentAlbum)
